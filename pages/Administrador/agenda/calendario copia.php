        ...
        (function($){
                ...
                var options = {
                    ...
                    // definimos que los agenda se mostraran en ventana modal
                        ...
                        width: '100%', 
                        // Definimos un largo del 100% a nuestro calendario
                        length:'60%',
      ...
      <div class="modal-body">
        <form action="" method="post">
                    ...
                    <select class="form-control" name="class" id="tipo">
                        <option value="event-info">Celo</option>
                        <option value="event-success">Ecografia</option>
                        <option value="event-important">Monta</option>
                        <option value="event-warning">Partos</option>
                        <option value="event-special">Pesajes</option>
                    </select>
